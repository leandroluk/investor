...
import {DeviceEntity as Entity} from '#/domain/account/entities';
import {DeviceRepository as Interface} from '#/domain/account/repositories';
...
export class DatabasePostgresDeviceRepository extends DAO<Entity> implements Interface {
